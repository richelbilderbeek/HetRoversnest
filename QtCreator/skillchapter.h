...
struct SkillChapter
{
  ...
  int GetSkillChapter() const noexcept { return m_skill_consequence.GetNextChapter(); }
  int GetNoSkillChapter() const noexcept { return m_no_skill_consequence.GetNextChapter(); }
