...
void DiceGameChapter::Do(Character& character) const
{
  ...
  {
    m_chapter.ShowText("Round #" + std::to_string(round + 1) + "/" + std::to_string(n_rounds) + "\n");
    //You
    ...
    m_chapter.ShowText("You throw: " + std::to_string(dice_you) + "\n");
    m_chapter.Wait();
    m_chapter.ShowText("Dwarf 1 throws: " + std::to_string(dice_1) + "\n");
    m_chapter.Wait();
    m_chapter.ShowText("Dwarf 2 throws: " + std::to_string(dice_2) + "\n");
    m_chapter.Wait();
    m_chapter.ShowText("Dwarf 3 throws: " + std::to_string(dice_3) + "\n");
    m_chapter.Wait();
