...
do
  ...
  echo "#ifndef GETFILES$NUMBER" >> $OUTPUT_HEADER_FILENAME
  echo "#define GETFILES$NUMBER" >> $OUTPUT_HEADER_FILENAME
  echo " " >> $OUTPUT_HEADER_FILENAME
  echo "#include <string>" >> $OUTPUT_HEADER_FILENAME
  echo " " >> $OUTPUT_HEADER_FILENAME
  echo "std::string Get$NUMBER();" >> $OUTPUT_HEADER_FILENAME
  echo "#endif //~define GETFILES$NUMBER" >> $OUTPUT_HEADER_FILENAME
